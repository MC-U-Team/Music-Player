...
public class GuiMusicPlayer extends GuiScreen implements IMusicPlayerEvents {
	...
	public GuiMusicPlayer(IMusicPlayer musicplayer) {
	...
	public void onGuiClosed() {
		...
		musicplayer.unregisterEventHandler(this);
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (searchstatustime + 4000 >= System.currentTimeMillis()) {
			drawString(fontRenderer, searchstatus, 11, 42, 0xFFF);
		}
	}
	...
	public void onSearchFailed(String error, Exception exeption) {
		searchTrackStatus("\u00A7cError occured: " + error);
	}
