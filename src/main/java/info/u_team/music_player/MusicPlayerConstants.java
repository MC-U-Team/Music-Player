...
public class MusicPlayerConstants {
	...
	public static final String COMMONPROXY = "info.u_team.music_player.proxy.CommonProxy";
	public static final String CLIENTPROXY = "info.u_team.music_player.proxy.ClientProxy";
