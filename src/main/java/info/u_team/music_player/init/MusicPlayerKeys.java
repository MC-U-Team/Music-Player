...
public class MusicPlayerKeys {
	...
	public static final KeyBinding skipForward = new KeyBinding(key_skip_forward, KeyConflictContext.UNIVERSAL, KeyModifier.ALT, InputMappings.Type.KEYSYM, GLFW.GLFW_KEY_KP_7, key_category);
	public static final KeyBinding skipBack = new KeyBinding(key_skip_back, KeyConflictContext.UNIVERSAL, KeyModifier.ALT, InputMappings.Type.KEYSYM, GLFW.GLFW_KEY_KP_9, key_category);
