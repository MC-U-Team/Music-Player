 ...
 * {@link #get()}. This method use the default implementation of
 * {@link #hashCode()} and {@link #equals(Object)}. This ensures there can't be
 * {@link WrappedObject} which are equals. This can be used in the Collection
 * Framework {@link Collection} for some special use.
 * 
 * @author HyCraftHD
 *
 * @param <T>
...
public class WrappedObject<T> {
	 ...
	 * 
	 * @param object
	 *            The object you want to wrap. Must match the generic type
	 */
