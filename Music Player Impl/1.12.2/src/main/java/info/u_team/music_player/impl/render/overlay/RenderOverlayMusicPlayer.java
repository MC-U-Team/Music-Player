package info.u_team.music_player.impl.render.overlay;

import com.sedmelluq.discord.lavaplayer.track.*;

import info.u_team.music_player.MusicPlayerConstants;
import info.u_team.music_player.impl.render.text.*;
...
public class RenderOverlayMusicPlayer {
	...
	public RenderOverlayMusicPlayer(MusicPlayer musicplayer) {
	...
	private void setProgress(AudioTrack track) {
	...
	public void draw() {
		...
		// Update music
		AudioTrack track = musicplayer.getTrackScheduler().getCurrentTrack();
		if (track == null) {
			return;
		} else {
			setSong(track);
