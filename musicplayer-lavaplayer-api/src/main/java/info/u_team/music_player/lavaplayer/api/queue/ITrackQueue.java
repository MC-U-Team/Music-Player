...
public interface ITrackQueue {
	...
	/**
	 * Get the calculated {@link IAudioTrack}. This method is a getter and can only return an {@link IAudioTrack} if {@link ITrackQueue#calculateNext()}
	 * has been called before with <strong>true<strong> as result.
	 * 
